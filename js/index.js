...
// body
const body = createCapsule(90, 300, 4, 1000, '../textures/yellow.jpg');
body.rotation.set(Math.PI / 2, 0, Math.PI / 2);
body.position.set(-10, 40, 0);
scene.add(body);

// tail
const tail = createCapsule(25, 300, 4, 1000, '../textures/yellow.jpg');
tail.rotation.set(Math.PI / 2, Math.PI / 25, Math.PI / 2);
tail.position.set(300, 110, 0);
scene.add(tail);

// back
const back = createCone(80, 300, 1000, '../textures/yellow.jpg');
...
// door
const door = createExtrude(80, 80, 180, '../textures/red.jpg');
door.position.set(-160, 20, -90);
scene.add(door);

// window 1
const win1 = createExtrude(40, 40, 180, '../textures/red.jpg');
win1.position.set(-60, 40, -90);
scene.add(win1);

// window 2
const win2 = createExtrude(40, 40, 180, '../textures/red.jpg');
win2.position.set(0, 40, -90);
scene.add(win2);

// window 2
const win3 = createExtrude(40, 40, 180, '../textures/red.jpg');
...
function animate() {
   ...
   // tCopHold.rotation.z -= 0.1;
    tCopFBladePiv.rotation.y += 0.15;
    tCopSBladePiv.rotation.y += 0.15;

    //bCopHold.rotation.z += 0.1;
    bCopFBladePiv.rotation.y += 0.15;
    bCopSBladePiv.rotation.y += 0.15;
